    ...
    <nav className="p-4 bg-gray-900">
      ...
      <div className="flex justify-between items-center lg:hidden">
        <div className="max-w-[140px] hover:scale-105 transition">
          <a href="/index.html">
            <img
              src="/src/assets/images/logos/logoBlancoChevignonClasicoSinFondo.png"
              alt="Logo"
              className="h-12 w-auto"
            />
          </a>
        </div>
        <div className="flex items-center justify-center rounded-lg bg-[#2f2f2f]">
          <button
            id="boton-menu"
            type="button"
            className="bg-transparent border-none inline-flex items-center justify-center p-2"
          >
            <svg
